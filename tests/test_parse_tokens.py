...
from clios.ast_builder import ErrorType, _Empty
from clios.tokenizer import LeftBracketToken
...
invalids = [
    ...
    [
        ...
        ParserError(ErrorType.SYNTAX_NOT_SUPPORTED, ctx={"token_index": 1}),
    ],
    [
        [Ot("op_not_found")],
        ParserError(ErrorType.OPERATOR_NOT_FOUND, ctx={"token_index": 0}),
